#macos-run.sh MAC_USER_PASSWORD VNC_PASSWORD TAILSCALE_AUTH_KEY MAC_REALNAME MAC_HOSTNAME
...
#start tailscaled daemon and connect
sudo tailscaled --state=/var/lib/tailscale/tailscaled.state &
sleep 3
sudo tailscale up --authkey=$3 --advertise-exit-node --ssh --hostname="$5"

echo ""
echo "=========================================="
echo "Tailscale IP: $(tailscale ip -4)"
echo "To connect via VNC: use Tailscale IP on port 5900"
echo "=========================================="
